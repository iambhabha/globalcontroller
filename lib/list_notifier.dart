...
class RectiveError {
  ...
  String toString() {
    return """
       the improper use of a  has been detected. 
      You should only use  or for the specific widthat will be updated.
      If you are seeing this error, you probably did not insert any observable variables into /
      or insert them outside the scope that  considers suitable for an update 
      (example:  => HeavyWid=> variableObservable).
      If you need to update a parent widand a child wid wrap each one in an .
      """;
  }
}
