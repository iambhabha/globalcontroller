...
import 'package:globalcontroller/extension_instance.dart';
import 'global_core/src/global_main.dart';
import 'global_core/src/smart_management.dart';
import 'global_core/src/typedefs.dart';
...
class RouterReportManager<T> {
  ...
  void appendRouteByCreate(GlobalLifeCycleMixin i) {
  ...
  void reportRouteWillDispose(T disposed) {
    ...
    for (final element in keysToRemove) {
      Global.markAsDirty(key: element);
  ...
  void _removeDependencyByRoute(T routeName) {
    ...
    for (final element in keysToRemove) {
      final value = Global.delete(key: element);
      if (value) {
